...
function cross(...values) {
  ...
  while (true) {
    ...
    while (++index5[i] === lengths[i]) {
      if (i === 0)
        return reduce4 ? product.map(reduce4) : product;
      index5[i--] = 0;
    }
  }
}
...
function nest(values, map8, reduce4, keys) {
  return function regroup(values2, i) {
    if (i >= keys.length)
      return reduce4(values2);
...
function quickselect(array8, k2, left2 = 0, right2 = Infinity, compare) {
  k2 = Math.floor(k2);
  left2 = Math.floor(Math.max(0, left2));
  right2 = Math.floor(Math.min(array8.length - 1, right2));
  ...
  while (right2 > left2) {
    if (right2 - left2 > 600) {
      ...
      quickselect(array8, k2, newLeft, newRight, compare);
    }
    const t = array8[k2];
    let i = left2;
    let j = right2;
    swap(array8, left2, k2);
    if (compare(array8[right2], t) > 0)
      swap(array8, left2, right2);
    while (i < j) {
      swap(array8, i, j), ++i, --j;
      while (compare(array8[i], t) < 0)
        ++i;
      while (compare(array8[j], t) > 0)
        --j;
    }
    if (compare(array8[left2], t) === 0)
      swap(array8, left2, j);
    else
      ++j, swap(array8, j, right2);
    if (j <= k2)
      left2 = j + 1;
    if (k2 <= j)
      right2 = j - 1;
...
function quantileIndex(values, p, valueof = number) {
  ...
  if (p <= 0)
    return minIndex(numbers4);
  if (p >= 1)
    return maxIndex(numbers4);
...
function pairs(values, pairof = pair) {
  ...
  for (const value of values) {
    if (first)
      pairs4.push(pairof(previous, value));
    previous = value;
    first = true;
  }
  return pairs4;
...
function shuffler(random) {
  return function shuffle2(array8, i0 = 0, i1 = array8.length) {
    let m3 = i1 - (i0 = +i0);
    while (m3) {
      const i = random() * m3-- | 0, t = array8[m3 + i0];
      array8[m3 + i0] = array8[i + i0];
      array8[i + i0] = t;
    }
    return array8;
  };
...
function each_default(callback) {
  for (var groups4 = this._groups, j = 0, m3 = groups4.length; j < m3; ++j) {
    for (var group4 = groups4[j], i = 0, n = group4.length, node; i < n; ++i) {
      if (node = group4[i])
        callback.call(node, node.__data__, i, group4);
    }
  }
  return this;
}
...
function bindIndex2(parent, group4, enter, update, exit, data) {
  var i = 0, node, groupLength = group4.length, dataLength = data.length;
  for (; i < dataLength; ++i) {
    if (node = group4[i]) {
      node.__data__ = data[i];
...
function bindKey2(parent, group4, enter, update, exit, data, key) {
  var i, node, nodeByKeyValue = /* @__PURE__ */ new Map(), groupLength = group4.length, dataLength = data.length, keyValues = new Array(groupLength), keyValue;
  for (i = 0; i < groupLength; ++i) {
    if (node = group4[i]) {
      keyValues[i] = keyValue = key.call(node, node.__data__, i, group4) + "";
...
function data_default2(value, key) {
  ...
  var bind = key ? bindKey2 : bindIndex2, parents = this._parents, groups4 = this._groups;
  if (typeof value !== "function")
    value = constant_default4(value);
  for (var m3 = groups4.length, update = new Array(m3), enter = new Array(m3), exit = new Array(m3), j = 0; j < m3; ++j) {
    var parent = parents[j], group4 = groups4[j], groupLength = group4.length, data = arraylike2(value.call(parent, parent && parent.__data__, j, parents)), dataLength = data.length, enterGroup = enter[j] = new Array(dataLength), updateGroup = update[j] = new Array(dataLength), exitGroup = exit[j] = new Array(groupLength);
    bind(parent, group4, enterGroup, updateGroup, exitGroup, data, key);
    for (var i0 = 0, i1 = 0, previous, next; i0 < dataLength; ++i0) {
      if (previous = enterGroup[i0]) {
        if (i0 >= i1)
...
var root2 = [null];
function Selection2(groups4, parents) {
  this._groups = groups4;
  this._parents = parents;
}
function selection2() {
...
function selectAll_default5(select) {
  ...
  for (var groups4 = this._groups, m3 = groups4.length, subgroups = [], parents = [], j = 0; j < m3; ++j) {
    for (var group4 = groups4[j], n = group4.length, node, i = 0; i < n; ++i) {
      if (node = group4[i]) {
        for (var children4 = select.call(node, node.__data__, i, group4), child, inherit2 = get2(node, id2), k2 = 0, l = children4.length; k2 < l; ++k2) {
...
function brush(dim) {
  var extent3 = defaultExtent, filter7 = defaultFilter2, touchable = defaultTouchable2, keys = true, listeners = dispatch_default("start", "brush", "end"), handleSize = 6, touchending;
  ...
  brush2.move = function(group4, selection4, event) {
    if (group4.tween) {
  ...
  function redraw() {
    var group4 = select_default5(this), selection4 = local3(this).selection;
    if (selection4) {
      group4.selectAll(".selection").style("display", null).attr("x", selection4[0][0]).attr("y", selection4[0][1]).attr("width", selection4[1][0] - selection4[0][0]).attr("height", selection4[1][1] - selection4[0][1]);
  ...
  function started(event) {
    ...
    if (!filter7.apply(this, arguments))
      return;
    var that = this, type2 = event.target.__data__.type, mode3 = (keys && event.metaKey ? type2 = "overlay" : type2) === "selection" ? MODE_DRAG : keys && event.altKey ? MODE_CENTER : MODE_HANDLE, signX = dim === Y ? null : signsX[type2], signY = dim === X ? null : signsY[type2], state = local3(that), extent4 = state.extent, selection4 = state.selection, W = extent4[0][0], w0, w1, N = extent4[0][1], n0, n1, E2 = extent4[1][0], e0, e1, S = extent4[1][1], s0, s1, dx = 0, dy = 0, moving, shifting = signX && signY && keys && event.shiftKey, lockX, lockY, points = Array.from(event.touches || [event], (t) => {
    ...
    e1 = e0;
    s1 = s0;
    var group4 = select_default5(that).attr("pointer-events", "none");
  ...
  brush2.extent = function(_) {
    return arguments.length ? (extent3 = typeof _ === "function" ? _ : constant_default5(number22(_)), brush2) : extent3;
  };
  brush2.filter = function(_) {
    return arguments.length ? (filter7 = typeof _ === "function" ? _ : constant_default5(!!_), brush2) : filter7;
  };
...
function bisector2(f) {
  ...
  if (f.length !== 2) {
    ...
    compare1 = f === ascending4 || f === descending2 ? f : zero3;
    compare2 = f;
    delta = f;
  }
  function left2(a4, x4, lo = 0, hi = a4.length) {
...
function density_default() {
  var x4 = defaultX, y4 = defaultY, weight = defaultWeight, dx = 960, dy = 500, r = 20, k2 = 2, o = r * 3, n = dx + o * 2 >> k2, m3 = dy + o * 2 >> k2, threshold2 = constant_default7(20);
  function grid(data) {
...
function flatArray(points, fx, fy, that) {
  const n = points.length;
  const array8 = new Float64Array(n * 2);
  for (let i = 0; i < n; ++i) {
    const p = points[i];
    array8[i * 2] = fx.call(that, p, i, points);
    array8[i * 2 + 1] = fy.call(that, p, i, points);
  }
  return array8;
}
...
function autoType(object2) {
  for (var key in object2) {
    var value = object2[key].trim(), number6, m3;
    if (!value)
      value = null;
    else if (value === "true")
      value = true;
...
function parser(type2) {
  return (input, init2) => text_default4(input, init2).then((text) => new DOMParser().parseFromString(text, type2));
}
...
function link_default(links) {
  var id2 = index3, strength = defaultStrength, strengths, distance = constant_default8(30), distances, nodes, count5, bias, random, iterations2 = 1;
  if (links == null)
    links = [];
...
function ascendingComparator(f) {
  return (d, x4) => ascending_default2(f(d), x4);
}
...
var bisectCenter3 = bisector_default(number_default2).center;
...
function circle_default() {
  var center2 = constant_default10([0, 0]), radius = constant_default10(90), precision = constant_default10(2), ring, rotate, stream = { point: point6 };
  ...
  circle.center = function(_) {
    return arguments.length ? (center2 = typeof _ === "function" ? _ : constant_default10([+_[0], +_[1]]), circle) : center2;
  };
  circle.radius = function(_) {
    return arguments.length ? (radius = typeof _ === "function" ? _ : constant_default10(+_), circle) : radius;
  };
  circle.precision = function(_) {
    return arguments.length ? (precision = typeof _ === "function" ? _ : constant_default10(+_), circle) : precision;
  };
  return circle;
}
...
function link(array8) {
  if (!(n = array8.length))
    return;
  var n, i = 0, a4 = array8[0], b;
  while (++i < n) {
    a4.n = b = array8[i];
    b.p = a4;
    a4 = b;
...
function clipRectangle(x06, y06, x12, y12) {
  ...
  return function(stream) {
    ...
    function polygonEnd() {
      var startInside = polygonInside(), cleanInside = clean && startInside, visible2 = (segments = merge3(segments)).length;
...
function count4(node) {
  var sum6 = 0, children4 = node.children, i = children4 && children4.length;
  if (!i)
    sum6 = 1;
  else
    while (--i >= 0)
      sum6 += children4[i].value;
  node.value = sum6;
}
...
function eachBefore_default(callback, that) {
  var node = this, nodes = [node], children4, i, index5 = -1;
  while (node = nodes.pop()) {
    callback.call(that, node, ++index5, this);
...
function eachAfter_default(callback, that) {
  var node = this, nodes = [node], next = [], children4, i, n, index5 = -1;
  while (node = nodes.pop()) {
    next.push(node);
    if (children4 = node.children) {
...
function sum_default(value) {
  return this.eachAfter(function(node) {
    var sum6 = +value(node.data) || 0, children4 = node.children, i = children4 && children4.length;
    while (--i >= 0)
      sum6 += children4[i].value;
    node.value = sum6;
  });
...
function shuffle(array8, random) {
  let m3 = array8.length, t, i;
  while (m3) {
    i = random() * m3-- | 0;
    t = array8[m3];
    array8[m3] = array8[i];
...
function pack_default() {
  ...
  pack.padding = function(x4) {
    return arguments.length ? (padding = typeof x4 === "function" ? x4 : constant_default11(+x4), pack) : padding;
  };
  return pack;
}
...
function treemap_default() {
  ...
  treemap.paddingInner = function(x4) {
    return arguments.length ? (paddingInner = typeof x4 === "function" ? x4 : constant_default11(+x4), treemap) : paddingInner;
  };
  ...
  treemap.paddingTop = function(x4) {
    return arguments.length ? (paddingTop = typeof x4 === "function" ? x4 : constant_default11(+x4), treemap) : paddingTop;
  };
  treemap.paddingRight = function(x4) {
    return arguments.length ? (paddingRight = typeof x4 === "function" ? x4 : constant_default11(+x4), treemap) : paddingRight;
  };
  treemap.paddingBottom = function(x4) {
    return arguments.length ? (paddingBottom = typeof x4 === "function" ? x4 : constant_default11(+x4), treemap) : paddingBottom;
  };
  treemap.paddingLeft = function(x4) {
    return arguments.length ? (paddingLeft = typeof x4 === "function" ? x4 : constant_default11(+x4), treemap) : paddingLeft;
  };
  return treemap;
}
...
function computeUpperHullIndexes(points) {
  ...
  let size = 2, i;
  for (i = 2; i < n; ++i) {
    while (size > 1 && cross_default(points[indexes4[size - 2]], points[indexes4[size - 1]], points[i]) <= 0)
      --size;
    indexes4[size++] = i;
  }
...
function ordinal() {
  ...
  scale2.range = function(_) {
    return arguments.length ? (range5 = Array.from(_), scale2) : range5.slice();
  };
...
function transformer2() {
  var domain = unit, range5 = unit, interpolate = value_default, transform2, untransform, unknown, clamp = identity4, piecewise2, output, input;
  function rescale() {
  ...
  scale2.domain = function(_) {
    return arguments.length ? (domain = Array.from(_, number4), rescale()) : domain.slice();
  };
  scale2.range = function(_) {
...
function identity5(domain) {
  ...
  scale2.domain = scale2.range = function(_) {
    return arguments.length ? (domain = Array.from(_, number4), scale2) : domain.slice();
  };
  scale2.unknown = function(_) {
    return arguments.length ? (unknown = _, scale2) : unknown;
  };
  ...
  domain = arguments.length ? Array.from(domain, number4) : [0, 1];
  return linearish(scale2);
}

// node_modules/d3/node_modules/d3-scale/src/nice.js
function nice4(domain, interval2) {
  domain = domain.slice();
...
function powish(transform2) {
  var scale2 = transform2(identity4, identity4), exponent2 = 1;
  function rescale() {
    return exponent2 === 1 ? transform2(identity4, identity4) : exponent2 === 0.5 ? transform2(transformSqrt, transformSquare) : transform2(transformPow(exponent2), transformPow(1 / exponent2));
  }
...
function radial() {
  ...
  scale2.range = function(_) {
    return arguments.length ? (squared.range((range5 = Array.from(_, number4)).map(square)), scale2) : range5.slice();
  };
  scale2.rangeRound = function(_) {
...
function quantile4() {
  ...
  scale2.copy = function() {
    return quantile4().domain(domain).range(range5).unknown(unknown);
  };
  return initRange.apply(scale2, arguments);
}
...
function threshold() {
  ...
  scale2.domain = function(_) {
    return arguments.length ? (domain = Array.from(_), n = Math.min(domain.length, range5.length - 1), scale2) : domain.slice();
  };
  scale2.range = function(_) {
    return arguments.length ? (range5 = Array.from(_), n = Math.min(domain.length, range5.length - 1), scale2) : range5.slice();
  };
  scale2.invertExtent = function(y4) {
    var i = range5.indexOf(y4);
...
function ticker(year, month, week, day, hour, minute) {
  ...
  function ticks3(start2, stop, count5) {
    ...
    const interval2 = count5 && typeof count5.range === "function" ? count5 : tickInterval(start2, stop, count5);
    const ticks4 = interval2 ? interval2.range(start2, +stop + 1) : [];
    return reverse4 ? ticks4.reverse() : ticks4;
  }
  function tickInterval(start2, stop, count5) {
    ...
    if (i === tickIntervals.length)
      return year.every(tickStep3(start2 / durationYear, stop / durationYear, count5));
    if (i === 0)
      return millisecond.every(Math.max(tickStep3(start2, stop, count5), 1));
...
function calendar(ticks3, tickInterval, year, month, week, day, hour, minute, second2, format2) {
  ...
  scale2.nice = function(interval2) {
    ...
    return interval2 ? domain(nice4(d, interval2)) : scale2;
  };
  scale2.copy = function() {
    return copy(scale2, calendar(ticks3, tickInterval, year, month, week, day, hour, minute, second2, format2));
  };
  return scale2;
}
function time() {
...
function transformer3() {
  var x06 = 0, x12 = 1, t03, t13, k10, transform2, interpolator = identity4, clamp = false, unknown;
  function scale2(x4) {
...
function transformer4() {
  var x06 = 0, x12 = 0.5, x22 = 1, s2 = 1, t03, t13, t22, k10, k21, interpolator = identity4, transform2, clamp = false, unknown;
  function scale2(x4) {
...
function diverging() {
  var scale2 = linearish(transformer4()(identity4));
  scale2.copy = function() {
...
function arrayAll3(select) {
  return function() {
    return array7(select.apply(this, arguments));
  };
}
...
var filter6 = Array.prototype.filter;
function children3() {
  return Array.from(this.children);
}
function childrenFilter3(match) {
  return function() {
    return filter6.call(this.children, match);
  };
}
...
function bindIndex3(parent, group4, enter, update, exit, data) {
  var i = 0, node, groupLength = group4.length, dataLength = data.length;
  for (; i < dataLength; ++i) {
    if (node = group4[i]) {
      node.__data__ = data[i];
...
function bindKey3(parent, group4, enter, update, exit, data, key) {
  var i, node, nodeByKeyValue = /* @__PURE__ */ new Map(), groupLength = group4.length, dataLength = data.length, keyValues = new Array(groupLength), keyValue;
  for (i = 0; i < groupLength; ++i) {
    if (node = group4[i]) {
      keyValues[i] = keyValue = key.call(node, node.__data__, i, group4) + "";
...
function data_default4(value, key) {
  ...
  var bind = key ? bindKey3 : bindIndex3, parents = this._parents, groups4 = this._groups;
  if (typeof value !== "function")
    value = constant_default12(value);
  for (var m3 = groups4.length, update = new Array(m3), enter = new Array(m3), exit = new Array(m3), j = 0; j < m3; ++j) {
    var parent = parents[j], group4 = groups4[j], groupLength = group4.length, data = arraylike3(value.call(parent, parent && parent.__data__, j, parents)), dataLength = data.length, enterGroup = enter[j] = new Array(dataLength), updateGroup = update[j] = new Array(dataLength), exitGroup = exit[j] = new Array(groupLength);
    bind(parent, group4, enterGroup, updateGroup, exitGroup, data, key);
    for (var i0 = 0, i1 = 0, previous, next; i0 < dataLength; ++i0) {
      if (previous = enterGroup[i0]) {
        if (i0 >= i1)
...
var root4 = [null];
function Selection4(groups4, parents) {
  this._groups = groups4;
  this._parents = parents;
}
function selection3() {
...
function selectAll_default7(selector) {
  return typeof selector === "string" ? new Selection4([document.querySelectorAll(selector)], [document.documentElement]) : new Selection4([array7(selector)], root4);
}

// node_modules/d3/node_modules/d3-shape/src/constant.js
function constant_default13(x4) {
...
function arc_default() {
  var innerRadius = arcInnerRadius, outerRadius = arcOuterRadius, cornerRadius = constant_default13(0), padRadius = null, startAngle = arcStartAngle, endAngle = arcEndAngle, padAngle = arcPadAngle, context = null, path2 = withPath(arc);
  function arc() {
    ...
    if (!(r1 > epsilon8))
      ...
      var a01 = a0, a11 = a1, a00 = a0, a10 = a1, da0 = da2, da1 = da2, ap = padAngle.apply(this, arguments) / 2, rp = ap > epsilon8 && (padRadius ? +padRadius.apply(this, arguments) : sqrt3(r0 * r0 + r1 * r1)), rc = min5(abs4(r1 - r0) / 2, +cornerRadius.apply(this, arguments)), rc0 = rc, rc1 = rc, t03, t13;
      if (rp > epsilon8) {
  ...
  arc.innerRadius = function(_) {
    return arguments.length ? (innerRadius = typeof _ === "function" ? _ : constant_default13(+_), arc) : innerRadius;
  };
  arc.outerRadius = function(_) {
    return arguments.length ? (outerRadius = typeof _ === "function" ? _ : constant_default13(+_), arc) : outerRadius;
  };
  arc.cornerRadius = function(_) {
    return arguments.length ? (cornerRadius = typeof _ === "function" ? _ : constant_default13(+_), arc) : cornerRadius;
  };
  arc.padRadius = function(_) {
    return arguments.length ? (padRadius = _ == null ? null : typeof _ === "function" ? _ : constant_default13(+_), arc) : padRadius;
  };
  arc.startAngle = function(_) {
    return arguments.length ? (startAngle = typeof _ === "function" ? _ : constant_default13(+_), arc) : startAngle;
  };
  arc.endAngle = function(_) {
    return arguments.length ? (endAngle = typeof _ === "function" ? _ : constant_default13(+_), arc) : endAngle;
  };
  arc.padAngle = function(_) {
    return arguments.length ? (padAngle = typeof _ === "function" ? _ : constant_default13(+_), arc) : padAngle;
  };
...
function line_default2(x4, y4) {
  var defined = constant_default13(true), context = null, curve = linear_default, output = null, path2 = withPath(line);
  x4 = typeof x4 === "function" ? x4 : x4 === void 0 ? x3 : constant_default13(x4);
  y4 = typeof y4 === "function" ? y4 : y4 === void 0 ? y3 : constant_default13(y4);
  function line(data) {
  ...
  line.x = function(_) {
    return arguments.length ? (x4 = typeof _ === "function" ? _ : constant_default13(+_), line) : x4;
  };
  line.y = function(_) {
    return arguments.length ? (y4 = typeof _ === "function" ? _ : constant_default13(+_), line) : y4;
  };
  line.defined = function(_) {
    return arguments.length ? (defined = typeof _ === "function" ? _ : constant_default13(!!_), line) : defined;
  };
...
function area_default5(x06, y06, y12) {
  var x12 = null, defined = constant_default13(true), context = null, curve = linear_default, output = null, path2 = withPath(area);
  x06 = typeof x06 === "function" ? x06 : x06 === void 0 ? x3 : constant_default13(+x06);
  y06 = typeof y06 === "function" ? y06 : y06 === void 0 ? constant_default13(0) : constant_default13(+y06);
  y12 = typeof y12 === "function" ? y12 : y12 === void 0 ? y3 : constant_default13(+y12);
  function area(data) {
  ...
  area.x = function(_) {
    return arguments.length ? (x06 = typeof _ === "function" ? _ : constant_default13(+_), x12 = null, area) : x06;
  };
  area.x0 = function(_) {
    return arguments.length ? (x06 = typeof _ === "function" ? _ : constant_default13(+_), area) : x06;
  };
  area.x1 = function(_) {
    return arguments.length ? (x12 = _ == null ? null : typeof _ === "function" ? _ : constant_default13(+_), area) : x12;
  };
  area.y = function(_) {
    return arguments.length ? (y06 = typeof _ === "function" ? _ : constant_default13(+_), y12 = null, area) : y06;
  };
  area.y0 = function(_) {
    return arguments.length ? (y06 = typeof _ === "function" ? _ : constant_default13(+_), area) : y06;
  };
  area.y1 = function(_) {
    return arguments.length ? (y12 = _ == null ? null : typeof _ === "function" ? _ : constant_default13(+_), area) : y12;
  };
  ...
  area.defined = function(_) {
    return arguments.length ? (defined = typeof _ === "function" ? _ : constant_default13(!!_), area) : defined;
  };
...
function descending_default2(a4, b) {
...
function pie_default() {
  var value = identity_default6, sortValues = descending_default2, sort4 = null, startAngle = constant_default13(0), endAngle = constant_default13(tau6), padAngle = constant_default13(0);
  function pie(data) {
    var i, n = (data = array_default3(data)).length, j, k2, sum6 = 0, index5 = new Array(n), arcs = new Array(n), a0 = +startAngle.apply(this, arguments), da2 = Math.min(tau6, Math.max(-tau6, endAngle.apply(this, arguments) - a0)), a1, p = Math.min(Math.abs(da2) / n, padAngle.apply(this, arguments)), pa = p * (da2 < 0 ? -1 : 1), v2;
    for (i = 0; i < n; ++i) {
  ...
  pie.value = function(_) {
    return arguments.length ? (value = typeof _ === "function" ? _ : constant_default13(+_), pie) : value;
  };
  ...
  pie.startAngle = function(_) {
    return arguments.length ? (startAngle = typeof _ === "function" ? _ : constant_default13(+_), pie) : startAngle;
  };
  pie.endAngle = function(_) {
    return arguments.length ? (endAngle = typeof _ === "function" ? _ : constant_default13(+_), pie) : endAngle;
  };
  pie.padAngle = function(_) {
    return arguments.length ? (padAngle = typeof _ === "function" ? _ : constant_default13(+_), pie) : padAngle;
  };
  return pie;
}
...
function link2(curve) {
  ...
  link3.x = function(_) {
    return arguments.length ? (x4 = typeof _ === "function" ? _ : constant_default13(+_), link3) : x4;
  };
  link3.y = function(_) {
    return arguments.length ? (y4 = typeof _ === "function" ? _ : constant_default13(+_), link3) : y4;
  };
...
function Symbol2(type2, size) {
  ...
  type2 = typeof type2 === "function" ? type2 : constant_default13(type2 || circle_default3);
  size = typeof size === "function" ? size : constant_default13(size === void 0 ? 64 : +size);
  function symbol() {
    let buffer;
    if (!context)
      context = buffer = path2();
  ...
  symbol.type = function(_) {
    return arguments.length ? (type2 = typeof _ === "function" ? _ : constant_default13(_), symbol) : type2;
  };
  symbol.size = function(_) {
    return arguments.length ? (size = typeof _ === "function" ? _ : constant_default13(+_), symbol) : size;
  };
...
function stack_default() {
  var keys = constant_default13([]), order = none_default2, offset = none_default, value = stackValue;
  function stack(data) {
  ...
  stack.keys = function(_) {
    return arguments.length ? (keys = typeof _ === "function" ? _ : constant_default13(Array.from(_)), stack) : keys;
  };
  stack.value = function(_) {
    return arguments.length ? (value = typeof _ === "function" ? _ : constant_default13(+_), stack) : value;
  };
  stack.order = function(_) {
    return arguments.length ? (order = _ == null ? none_default2 : typeof _ === "function" ? _ : constant_default13(Array.from(_)), stack) : order;
  };
...
function zoom_default2() {
  ...
  zoom.scaleTo = function(selection4, k2, p, event) {
    zoom.transform(selection4, function() {
      var e = extent3.apply(this, arguments), t03 = this.__zoom, p02 = p == null ? centroid(e) : typeof p === "function" ? p.apply(this, arguments) : p, p1 = t03.invert(p02), k1 = typeof k2 === "function" ? k2.apply(this, arguments) : k2;
  ...
  zoom.translateTo = function(selection4, x4, y4, p, event) {
    zoom.transform(selection4, function() {
      ...
      return constrain(identity6.translate(p02[0], p02[1]).scale(t.k).translate(
        typeof x4 === "function" ? -x4.apply(this, arguments) : -x4,
        typeof y4 === "function" ? -y4.apply(this, arguments) : -y4
      ), e, translateExtent);
    }, p, event);
  ...
  function dblclicked(event, ...args) {
    if (!filter7.apply(this, arguments))
      return;
    var t03 = this.__zoom, p02 = pointer_default(event.changedTouches ? event.changedTouches[0] : event, this), p1 = t03.invert(p02), k1 = t03.k * (event.shiftKey ? 0.5 : 2), t13 = constrain(translate(scale2(t03, k1), p02, p1), extent3.apply(this, args), translateExtent);
    noevent_default3(event);
    if (duration > 0)
  ...
  zoom.filter = function(_) {
    return arguments.length ? (filter7 = typeof _ === "function" ? _ : constant_default14(!!_), zoom) : filter7;
  };
  zoom.touchable = function(_) {
    return arguments.length ? (touchable = typeof _ === "function" ? _ : constant_default14(!!_), zoom) : touchable;
  };
  zoom.extent = function(_) {
    return arguments.length ? (extent3 = typeof _ === "function" ? _ : constant_default14([[+_[0][0], +_[0][1]], [+_[1][0], +_[1][1]]]), zoom) : extent3;
  };
